...
# Bonn long-sequence config - preprocessed long sequences
bonn_s1_numbers = [50, 100, 110, 150, 200, 250, 300, 350, 400, 450, 500]
bonn_s1_configs = {
    f"bonn_s1_{num}": {
    ...
    for num in bonn_s1_numbers
}
dataset_metadata.update(bonn_s1_configs)
